...
public class SplashActivity extends BaseActivity implements SplashPresenter.SplashView {
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        tvSignUp.setOnClickListener(view -> {
            splashPresenter.createUser("rahul.abrol@toppr.com", "123456789", localDbManager);
        });
        ...
        splashPresenter.haltScreen(TIME, "rahul.abrol@toppr.com", "123456789", localDbManager);
    }
