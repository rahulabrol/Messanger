 ...
 * <p>
 * Maintain local database for chat users.
 */
public class DatabaseManager {
    private static final String TAG = DatabaseManager.class.getSimpleName();

    /**
     * Class {@link LocalHelper} used to display all
     ...
     */
    public static final class LocalHelper extends SQLiteOpenHelper {
         ...
         */
        private LocalHelper(final Context context) {
         ...
         */
        public static LocalHelper getInstance(final Context context) {
...
//            boolean isContainChat = cursor.getCount() > 0;
    ...
    /**
     * Class To handle all remote database (FIREBASE) related
     * work.
     * CRUD Operation can be performed here.
     */
    public static final class RemoteHelper {
        private FirebaseDatabase mFirebaseInstance;
        //        private DatabaseReference refrences;
...
//            mFirebaseInstance.setPersistenceEnabled(true);
        ...
        /**
         * Method used to initalize firebase db.
         *
         * @return current class inctance.
         */
        ...
        /**
         * Set the refrences from where user want to fetch data.
         *
         * @param name name of the refrences (like table USERS).
         * @return refrence.
         */
        public DatabaseReference setReferences(final String name) {
            return mFirebaseInstance.getReference(name);
        }

        /**
         * Method used to create Child of node and set value.
         * Example:- Node(Message)-->
         * Child(UniqueId like"EASOIUD2329dda")-->
         * Values(MESSAGE model).
         *
         * @param ref      refrence of a table.
         * @param messages model that need to b saved.
         * @return key
         */
        public String setChildWithValue(final DatabaseReference ref, final Messages messages) {
            //Randomly create a key with push method and
            // get the key in local variable.
